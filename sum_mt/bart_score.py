...
class BARTScorer:
    def __init__(self, device='cuda:0', max_length=1024, model_base = 'facebook/bart-large-cnn', checkpoint = 'facebook/bart-large-cnn'):
        # Set up model
        self.device = device
    ...
    def load(self, path=None):
        ...
        logger.info('BARTSCorer loading from %s', path)
